...
another_reviewer.rate_hw(another_student, 'Python', 2)
another_reviewer.rate_hw(another_student, 'Python', 2)
...
print("Средняя оценка за домашние задания по всем студентам в рамках курса Python:", average_student_grade(students, 'Python'))
print("Средняя оценка за лекции всех лекторов в рамках курса Python:", average_lecturer_grade(lecturers, 'Python'))
